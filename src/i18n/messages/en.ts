...
export const en = {
  ...
  topbar: {
    ...
    search: {
      ...
      typeMore: "Type at least 2 characters to search people or applications",
      tryAnother: "Try another name, email, or section",
    ...
    searchPlaceholder: "Search sections, users, or applications…",
    brandAlt: "Zelify",
    navPrimary: "Primary",
